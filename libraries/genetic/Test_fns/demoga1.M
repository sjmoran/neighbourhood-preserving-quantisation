...
% figures with the mouse by clicking in the area of the shape. These 
% figures are the parents for the next generation. The offspring are
...
% or a star or ..., imagine, what you want and select appropriate points.
%
